...
#fução para escrever os valores
...
def limpar_tela():
    ...
    valor_texto.set("")    
#criarlabel
app_label = Label(frame_tela, textvariable=valor_texto, width=16, height=2, padx=7, relief="flat",anchor="e",bd=0,justify= RIGHT, font=('Ivy 18'), bg='#141236',fg=cor2 )
